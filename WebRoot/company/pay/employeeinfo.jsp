  ...
  <div id="sum1">
   ...
   <div class="content">
       ...
       <div class="content-right">
           ...
           <span><a href="${foritou}/company/pay/companysetting.jsp"  >企业信息</a> </span>
          
           <span><a href="${foritou}/company/pay/employeeinfo.jsp"style="background:#ff6537;color:#fff;border-radius: 4px;" >员工信息</a> </span>      
           </div>
           <div class="content-right-bottom" style="border-top:1px solid #eee;padding-top:10px;">
             <div class="order-top">
                  <div class="order-cell" style="width:160px;">员工姓名</div>
                  <div class="order-cell" style="width:54px;">性别</div>
                  <div class="order-cell" style="width:200px;">联系方式</div>
                  <div class="order-cell" style="width:250px;">所在地</div>
                  <div class="order-cell" style="width:90px;">操作</div>
               </div>
               <c:forEach items="${company.employeeSet }" var="employee">
               <div style="border-bottom:1px solid #eee;height:30px;">
                <div class="order-cell" style="width:160px;">${employee.nickname }</div>
                  <div class="order-cell" style="width:54px;">
								<c:choose>
                  ...
                  <div class="order-cell" style="width:200px;">${employee.phone }</div>
                  <div class="order-cell" style="width:250px;">${employee.city }</div>
                  <div class="order-cell " style="width:90px;"><a href="${foritou }/employee_delete.action?id=${employee.id}" class="delete"> 删除</a></div>
               </div>
               </c:forEach>
               </div>
           </div>
