...
.order-cell .delete a{
 ...
 <li><a class="nav-level1-lable1" href="${foritou }/shoptype_getShop.action?id=1">美食</a></li>
   ...
   <div class="content">
       <div class="content-left">
           <div class="item">
              ...
              <ul>
                 ...
                 <li><a href="${foritou}/company/pay/mycollection.jsp " style="background:#ff6537; color:#fff;font-size:14px;line-height:30px;">我的收藏</a></li>    
              </ul>
           </div>
           <div class="item">
              <span>员工评价</span>
       ...
       <div class="content-right">
           ...
           <div class="content-right-bottom">
               <div class="order-top">
                  <div class="order-cell" style="width:300px;">收藏项目</div>
                  <div class="order-cell" style="width:120px;">联系方式</div>
                  <div class="order-cell" style="width:230px;">地址</div>
                  <div class="order-cell" style="width:120px;">操作</div>
               </div>
               <c:forEach items="${sessionScope.company.collectSet }" var="collection">
               <div class="order-item">
                  
                  <div class="order-info">
                    <div class="order-cell" style="width:300px;">
                      <a href="#" style="float:left;display:block;padding:10px 0px 10px 40px;"><img src="${foritou }/image/shop/${collection.pic}" width="81" height="50"></a>
                      <div style="float:left;padding-top:10px;">
                      
                      <a>${collection.shop.name }</a>
                     
                      <div>
                      <a style="color:#ff6537;text-decoration:none;" href="#">商家信息</a>
                      </div>
                       </div>
                    </div>
                   
                    <div class="order-cell" style="width:120px;margin-top:10px;">${collection.shop.phone }</div>
                     <div class="order-cell" style="width:230px;margin-top:10px;">
                       <div><span>${collection.shop.address }</span></div>
                       
                     </div>
                     <div class="order-cell" style="width:70px; margin-left: 34px;">
                     <span><a style="display:block; width:50px;height:30px; background:#ff6537; text-decoration:none; color:#fff; border-radius: 4px;margin-top:15px;" href="${foritou }/collection_deletebyid.action?id=${collection.id }">取消收藏</a></span>
   ...
   <div id="bottom">
	    ...
	    <div class= style="z-index:40;""clear"></div> 
	</div>
    </div>
   </div>
  </body>
