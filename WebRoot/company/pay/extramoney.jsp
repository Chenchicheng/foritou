   ...
   <div class="content">
       <div class="content-left">
           ...
           <div class="item" style="border:none;">
              <span>我的账户</span>
              <ul>
                 <li><a href="${foritou}/company/pay/extramoney.jsp" style="background:#ff6537; color:#fff;font-size:14px;line-height:30px;">我的余额</a></li>
                 <li><a href="${foritou}/company/pay/companysetting.jsp">账户设置</a></li>    
              </ul>
           </div>         
        </div>
       <div class="content-right">
           ...
           <span>您当前的余额为：
           <i style="color:#ff6537;font-size:18px;    margin-right: 4px;">￥${sessionScope.company.money }</i>元
           </span>
           </div>
           <div class="content-right-bottom">
                      <a style="display:block; width:90px;height:30px; background:#ff6537; text-decoration:none; color:#fff; border-radius: 4px;    float: right;    padding: 5px;
    font-size: 20px;text-align: center;margin-top: 20px;" href="#">充值</a>
           </div>
