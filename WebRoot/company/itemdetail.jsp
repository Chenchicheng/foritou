...
<div id="header">
   ...
   <div id="content">
     <div class="content-top">
           ...
           <div class="right">
               <p><img src="${foritou }/company/img/success.png" style="width:50px;height:50px;">
               <a>订单状态：交易成功</a>
               </p>
               <p>
               <a>您可以：</a>
   ...
   <div class="total-line"><span>订单总价：</span> 
   <span>${sessionScope.oldForder.total}</span>
   </div>
   <div class="total-line"><span>实付款：</span><span style="color:#ff6537">${sessionScope.oldForder.total}</span></div>
   </div>
   </div>
   <!-- 尾部开始 -->
