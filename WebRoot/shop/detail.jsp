...
function selectdiscount(e){
    ...
    { 
      'size.id':e.lang, 
        ...
        $("#discount_number").html(data.discount.discount+"折");
        $("#discount_price").html("售价："+data.discount.personprice+"元");
    }); 
}
$(function(){
//加载地图
   ...
   <div id="middle">
   	<div id="middle-top">
   		...
   		<span style="font-size: 12px;">》</span>
   			...
   			<a class="bread-nav" href="${foritou }/shop/detail.jsp">${shop.name }</a>
   		...
   		<div id="shopinfo-right">
   			<div class="shop-discount">
   				...
   				<h2 id="discount_info" class="shop-discount-right" style="margin: 0px;">
   					...
   					<span id="discount_number" class="price-discount">${discount.discount }折</span>
   					<span id="discount_price" class="price-symbol"><label>单价：</label>¥${discount.personprice }元</span>
   		 ...
   		 <!--    <div class="shop-discount">
   			...
   			<div class="shop-discount">
   				...
   				<input type="text" class="quantity" name="q" value="1" maxlength="9" data-max="500">
   				<button  class="item" data-action="+" gaevent="top/plus" type="button">+</button>
   				</span>
   			</div>
   			<div class="shop-purchase">
   				
   				<span><input class="card-buy" type="submit" value="加入购物车"></span>
