				  ...
				  /*     errorPlacement:function(error,){//定义错误消息存储位置
						...
						rules : { //配置验证规则；key就是验证的dom对象，value:调用的验证方法是json格式
							...
							//	rangelength : [ 6, 12 ]//设定长度
								remote : {
									url : 'shop_checkPhone.action',//兼容IE
									type : "post"
								}
							},
						    email : {
...
margin-left: 20px;
 ...
 <form method="post" id="shopFF" action="${foritou}/shop_enroll.action">
					...
					<div class="field-group">
						<label for="password" class="field-item" > <em style="color: #D00;font-weight: 500;">*</em>密&nbsp;&nbsp;码</label> 
						<input type="password" name="password" class="f-text"/>
					</div>
					<div class="field-group">
