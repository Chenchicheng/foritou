...
public class DigestUtil {
	...
	public static void main(String[] args) {
		...
		System.out.println(DigestUtil.hmacSign("123", "deepnets"));
		...
		System.out.println(DigestUtil.digest("f1e2ae6e22d5a0e52c2b02b5fa543bf1"));
		//System.out.println(DigestUtil.getHmac(,"abc"));
